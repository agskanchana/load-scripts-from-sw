...
Tags: google analytics, facebook pixel, performance
...
This plugin will load external analytical and other scripts from service worker
...
= 1.0 =
* first release with google analytic and facebook pixel option
